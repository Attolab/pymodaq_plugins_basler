...
from pymodaq_plugins_basler.hardware.baslerGigE import DartCamera


class DAQ_2DViewer_BaslerGigE(DAQ_2DViewer_GenericPylablibCamera):
    ...
    params = DAQ_2DViewer_GenericPylablibCamera.params + [
        ...
        {'title': 'Gain (Raw)', 'name': 'gain', 'type': 'int', 'value': 200, 'min': 200, 'max': 400},
    ]
    ...
    def commit_settings(self, param: Parameter) -> None:
        ...
        if param.name() == "auto_exposure":
            ...
            self.controller.camera.GainRaw.SetValue(param.value())
        else:
